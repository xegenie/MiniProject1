...
<!-- 	<link rel="stylesheet" href="static/css/adminboardlist.css"> -->
    ...
    if (boardIdParam != null) {
        ...
        if (isSuccess) {
            out.println("<script>alert('게시글이 삭제되었습니다.'); location.href='adminboardlist.jsp';</script>");
        } else {
...
<div style="margin-left:15%;padding:1px 16px;">
  <section>
    <div class="container">
    	<form action="adminboardinsert_pro.jsp" method="post">
    <div class="title-box">
    ...
    <input type="hidden" name="bType" value="게시판"> <!-- bType 추가 -->
    <div class="board-box">
    			...
    			<tbody>
				    <c:forEach items="${Boardlist}" var="board">
				        <tr>
				            ...
				            <td>${board.updDate}</td>
				             <td>
					            <button class="updbtn" onclick="location.href='adminboardupdate.jsp?board_id=${board.boardNo}'">수정</button>
